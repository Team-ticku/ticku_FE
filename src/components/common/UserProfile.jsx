...
function UserProfile({ height, width, fontsize, padding, isAnonymous }) {
  ...
  useEffect(() => {
    if (!isAnonymous) {
      // isAnonymous가 false일 경우에만 사용자 정보를 가져오기
      ...
      setUserName("익명"); // 익명이면 이름을 "익명"으로 설정
    }
  }, [isAnonymous]); // isAnonymous 값이 변경되면 재실행
